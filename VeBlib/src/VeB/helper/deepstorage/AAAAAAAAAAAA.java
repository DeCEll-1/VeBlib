...
public class AAAAAAAAAAAA {
    ...
    public void function(java.util.List<Vector2f> vector2fList, List<Color> colorList, int PolygonModeMode, ViewportAPI viewport){
        vector2fList = VeBlib_VectorHelper.ListVector2fsClockwise(vector2fList);

        Vector2f middlePoint = VeBlib_VectorHelper.GetTheMiddlePointInAVector2fList(vector2fList);
