...
public class DEAlib_EmpArcVisual_Test {//originally had  extends BaseEntity implements CombatEntityAPI, EmpArcEntityAPI
    ...
    public DEAlib_EmpArcVisual_Test(Vector2f from, CombatEntityAPI fromAnchor, Vector2f to, CombatEntityAPI toAnchor,
