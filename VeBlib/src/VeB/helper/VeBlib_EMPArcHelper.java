...
import VeB.helper.helperHelperClasses.VeBlib_DamageBaseClass;
...
import static VeB.helper.VeBlib_BoundsHelper.GetRandomBoundLocation;


public class VeBlib_EMPArcHelper {
     ...
     * @return if the proccess completed successfully returns true, false othervise. so instead of crashing it just, doesnt work
     */
    public static boolean SpawnDamagingEMPArc(ShipAPI DamageSource, Vector2f from, CombatEntityAPI target, VeBlib_DamageBaseClass DamageBaseClass, float range, String ImpactSoundID, float thiccness, java.awt.Color fringe, java.awt.Color core) {
     ...
     * @return if the proccess completed successfully returns true, false othervise. so instead of crashing it just, doesnt work
     */
    public static boolean SpawnEMPArcLineDamaging(Vector2f from, float angle, int lenght, float thiccness, float space, VeBlib_DamageBaseClass DamageInfo, ShipAPI source, java.awt.Color fringe, java.awt.Color core) {
        try {
            Vector2f to = new Vector2f();
