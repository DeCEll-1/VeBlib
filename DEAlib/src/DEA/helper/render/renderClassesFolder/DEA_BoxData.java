...
public class DEA_BoxData {

    public DEA_BoxData(Vector2f leftTop, Vector2f rightTop, Vector2f leftBottom, Vector2f rightBottom, Color lineColor, int PolygonModeMode) {
