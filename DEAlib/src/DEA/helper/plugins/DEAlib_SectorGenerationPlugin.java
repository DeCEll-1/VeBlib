...
public class DEAlib_SectorGenerationPlugin implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        if (starSystemDataList != null) {
            ...
            for (DEAlib_StarSystemData data : starSystemDataList) {
                ...
                if (data.starList != null) {
                    //çalış
                    for (DEAlib_StarData starData : data.starList) {
                ...
                if (data.planetList != null) {
                    ...
                    for (DEAlib_PlanetData planetData : data.planetList) {
...
//            Iterator PirateModeIterator = data.PirateMode.iterator();
                ...
                if (data.marketList != null) {
                    for (DEAlib_MarketData marketData : data.marketList) {
...
//                }
                ...
                if (data.astreoidBeltDataList != null) {
                    for (DEAlib_AstreoidBeltData astreoidData : data.astreoidBeltDataList) {
                ...
                if (data.ringBandDataList != null) {
                    for (DEAlib_RingBandData ringBandData : data.ringBandDataList) {
                ...
                if (data.sectorEntityTokenList != null) {
                    for (DEAlib_SectorEntittyTokenData sectorEntityTokenData : data.sectorEntityTokenList) {
