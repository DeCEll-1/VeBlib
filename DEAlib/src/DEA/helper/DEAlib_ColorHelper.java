...
import static DEA.helper.DEAlib_Statics.random;

public class DEAlib_ColorHelper {
    ...
    public static Color getColorFromHexString(String string) {
        return DEAlib_StringHelper.getColorFromHexString(string);
    }
    ...
    public static Color randomiseAlpha(Color color) {
        return new Color(color.getRed(), color.getGreen(), color.getBlue(), random.nextInt(255));
    }
